<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages.master" AutoEventWireup="true" CodeFile="updateEmployee.aspx.cs" Inherits="updateEmployee" %>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        ...
                        <asp:TemplateField HeaderText="Date Joined"  HeaderStyle-HorizontalAlign="Left"> 
                <EditItemTemplate> 
                    <asp:Textbox ID="t14" runat="server" class="textbox" Text='<%# Bind("date_joined") %>'></asp:Textbox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" 
                    ControlToValidate="t14" ErrorMessage="Enter Date joined" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <ItemTemplate> 
                    <asp:Label ID="lbl14" runat="server" Text='<%# Bind("date_joined") %>'></asp:Label> 
                </ItemTemplate> 
