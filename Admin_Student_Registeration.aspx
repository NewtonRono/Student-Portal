<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages.master" AutoEventWireup="true" CodeFile="Admin_Student_Registeration.aspx.cs" Inherits="Admin_Student_Registration" %>
    ...
    <table frame="border" style="width: 100%">
         ...
         <tr>
           ...
           <tr>
            <td style="text-align: left; width: 116px">
               CGPA:</td>
            <td style="width: 151px">
                <asp:TextBox ID="cgpa" runat="server" CssClass="textbox" Width="150px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" 
                    ControlToValidate="cgpa" ErrorMessage="Enter CGPA" ForeColor="Red"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator14" runat="server" 
                    ControlToValidate="cgpa" ErrorMessage="Enter valid cgpa" ForeColor="Red" 
            ...
            <td style="width: 151px"></td>
               ...
               Warning Count:</td>
            <td style="width: 151px">
                <asp:TextBox ID="wc" runat="server" CssClass="textbox" Width="150px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" 
                    ControlToValidate="wc" ErrorMessage="Enter Warning Count" ForeColor="Red"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" 
                    ControlToValidate="wc" ErrorMessage="Enter valid Warning Count i.e of one integer" ForeColor="Red" 
        ...
        <tr>
         <td style="text-align: left; width: 116px">
                Section:</td>
            <td style="width: 151px">
                <asp:TextBox ID="sec" runat="server" CssClass="textbox" Width="150px"></asp:TextBox>
            </td>
            <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
                    ControlToValidate="sec" ErrorMessage="Provide Section for Student" ForeColor="Red"></asp:RequiredFieldValidator>
